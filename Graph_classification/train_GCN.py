...
parser.add_argument("--dataset", default="../data/Traceparts-dataset/Graphml_models", help="Name of the graph (.graphml) dataset.")
...
# save paths
model_name = 'GCN' + "_" + str(datetime.today().strftime('%m-%d'))
